...
import '../styles/pages/InformationWrite.css';
...
function InformationWrite() {
  ...
  const [inforBoardContent, setInforBoardContent] = useState({
    title: '',
    content: '',
  });
  ...
  const getValue = (e) => {
    ...
    setInforBoardContent({
      ...inforBoardContent, // freeBoardContent의 내용을 가져옴
      [name]: value, // name에 집어넣은 후 그 값을 value로 바꿔 저장
    });

    // console.log(name, value); // name : 제목, value : 제목칸에 타이핑하는 글
    console.log(inforBoardContent);
  };
